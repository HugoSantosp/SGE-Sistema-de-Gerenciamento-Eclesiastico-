...
<a href="#" onclick="inserir()" type="button" class="btn btn-dark"> <i class="bi bi-person-plus"></i> Novo Pastor</a>
</div>
              ...
              <?php 
                ...
                <tr>
                      ...
                      <td>
                        ...
                        <a href="#" class="text-info" onclick="InfoDados('<?php  echo $nome ?>','<?php  echo $email ?>','<?php  echo $telefone ?>','<?php echo $documento ?>','<?php echo $endereco ?>','<?php echo $foto ?>','<?php echo $data_nascF ?>','<?php echo $data_cadF ?>')" title="Mostrar Registro" >
...
function editar(id,nome,email,telefone,documento,endereco,foto,data_nasc){
    ...
    $.ajax({
            ...
            success: function(menssagem){
                ...
                if(menssagem.trim() == "Salvo com Sucesso"){
                      $('#btn-fechar').click()
                      window.location ='index.php?pag=pastores'
...
function InfoDados(nome,email,telefone,documento,endereco,foto,data_nasc,data_cad){
