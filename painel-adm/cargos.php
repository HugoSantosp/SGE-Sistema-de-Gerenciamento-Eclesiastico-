...
<a href="#" onclick="inserir()" type="button" class="btn btn-dark"> <i class="bi bi-person-plus"></i> Novo Cargo Eclesiástico</a>
</div>
    ...
    <table id="exemplo" class="table table-bordered border-dark table-dark table-hover table-striped text-center  my-4 pt-4  " style="width:100%">
              ...
              <?php 
                ...
                <tr>
                      ...
                      <td>
                        <a href="#" class="text-primary" onclick="editar('<?php  echo $id ?>','<?php  echo $nome ?>')" title="Editar Registro">
      ...
      <form id="form" method="post">
                  ...
                  <div class="modal-body">
                      <div class="row">
                          <div class="col-md-6">
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Nome Do cargo</label>
                                <input type="text" class="form-control" id="nome" name="nome" placeholder="Missionário"   required="required">
                              </div>
                          </div>
    ...
    $.ajax({
            ...
            success: function(menssagem){
                ...
                if(menssagem.trim() == "Salvo com Sucesso"){
                      $('#btn-fechar').click()
                      window.location ='index.php?pag=cargos'
