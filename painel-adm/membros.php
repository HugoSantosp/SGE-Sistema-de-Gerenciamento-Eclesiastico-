    ...
    <table id="exemplo" class="table table-bordered border-dark table-dark table-hover table-striped  my-4 pt-4 table-responsive" style="width:100%">
              ...
              <?php 
                ...
                <tr>
                      ...
                      <td>
                        <a href="#" class="text-primary" onclick="editar('<?php  echo $id ?>','<?php  echo $nome ?>','<?php  echo $telefone ?>','<?php echo $documento ?>','<?php echo $endereco ?>','<?php echo $foto ?>','<?php echo $data_nasc ?>','<?php echo $igreja ?>','<?php echo $nome_church ?>','<?php echo $situacao ?>','<?php echo $nome_funcao ?>' )" title="Editar Registro">          
                        ...
                        <a href="#" class="text-success" onclick="InfoDados('<?php  echo $nome ?>','<?php  echo $telefone ?>','<?php echo $documento ?>','<?php echo $endereco ?>','<?php echo $foto ?>','<?php echo $data_nascF ?>','<?php echo $data_cadF ?>','<?php echo $nome_church ?>','<?php echo $situacao ?>','<?php echo $nome_funcao?>')" title="Mostrar Registro" >
                        ...
                        <a href="#" class="text-warning" onclick="MudarStatus('<?php  echo $id ?>','<?php  echo $situacao2?>')" title=" <?php echo $titulo; ?>" >
                      ...
                      <!-- <div class="col-md-6 ">
                              <div class="mb-3">
                                ...
                                <select class="sel2 form-select " id="situacao" name="situacao" style="width: 100%">
                                 <option  value="1" selected>Escolha uma opção</option> 
                        ...
                        <div class="col-md-6">
                          ...
                          <div class="col-md-6">
                              ...
                              <div class="mb-3">
                                ...
                                <select class="sel2 form-select" id="funcao" name="funcao" style="width: 100%">
...
function editar(id,nome,telefone,documento,endereco,foto,data_nasc,igreja,situacao,funcao){
...
function InfoDados(nome,telefone,documento,endereco,foto,data_nasc,data_cad,igreja,situacao,funcao){
...
function MudarStatus(id, situacao){
    
    $.ajax({
        url: "membros/mudar-status.php",
        type: 'POST',
        data: {id,situacao},
        dataType : "text",
