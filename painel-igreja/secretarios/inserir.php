...
$id_reg = @$result[0]['id'];
     ...
     if($id == "" || $id == 0){
        ...
        $consulta = $pdo -> prepare("INSERT INTO usuario SET nome = :nome, documento = :documento, email = :email, senha = '123', nivel='Secretario', id_pessoa ='$last_id', foto ='$imagem',igreja ='$id_igreja'; ");
        $consulta->bindValue(":nome","$nome");
        $consulta->bindValue(":email","$email");
        $consulta->bindValue(":documento","$documento");
        $consulta->execute();
      ...
      if($imagem == "sem-foto.jpg"){
         $consulta = $pdo -> prepare("UPDATE usuario SET nome = :nome, documento = :documento, email = :email,igreja ='$id_igreja'WHERE id_pessoa = '$id' and nivel ='Secretario' ");
        }else{
        ...
        $foto = $result[0]['foto'];
         ...
         $consulta = $pdo -> prepare("UPDATE usuario SET nome = :nome, documento = :documento, email = :email, foto ='$imagem',igreja ='$id_igreja' WHERE id_pessoa = '$id' and nivel ='Secretario' ");     
