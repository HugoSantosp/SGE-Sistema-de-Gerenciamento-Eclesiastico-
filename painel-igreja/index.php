...
//RECUPERA OS DADOS DA IGREJA
$consulta = $pdo -> query("SELECT * FROM igrejas WHERE id= ' $id_igreja' ");
$result = $consulta -> fetchAll(PDO::FETCH_ASSOC);
$nome_igreja2 = $result[0]['nome'];
      ...
      <li>
        ...
        <ul class="sub-menu">
          <li><a class="link_name" href="#">Cadastros</a></li>
           <li><a href="index.php?pag=tarefas">Tarefas</a></li>
     ...
     <!--  <li>
      ...
      <li>
        ...
        <ul class="sub-menu">
          ...
          <li><a href="#" class="tarefas" id="tarefas" >Tarefas</i></a></li>
...
<section class="home-section">
    <div class="home-content">
      ...
      <span class="text-uppercase fs-3 align-top mx-3 my-3 text-decoration-underline"><?php if ($pag === 'home'){ echo 'DASHBOARD de '.$nome_igreja2;}else { echo $pag.' de '.$nome_igreja2;} ;?></span>
