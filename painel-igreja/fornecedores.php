...
<a href="#" onclick="inserir()" type="button" class="btn btn-dark"> <i class="bi bi-person-plus"></i> Novo Fornecedor</a>
</div>
...
<div class="modal" id="modalDados" tabindex="-1">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title"><span id="tituloModal">Exibir Informações do Fornecedor</span> </h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
              ...
              <div class="modal-body">
                ...
                <hr>
                <span><b>Produto / Serviços:</b>
                  <span id="produto-dados"></span>
                </span>
...
<div class="modal fade" id="modalForm" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="tituloModal">Cadastrar Fornecedor</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      ...
      <form id="form" method="post">
                  ...
                  <div class="modal-body">
                      ...
                      <div class="row">
                          ...
                          <div class="col-md-6">
                              <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Produto / Serviços</label>
                                <input type="text" class="form-control" id="produto" name="produto" value="" required="required">
                              </div>
                     ...
                     <div class="row">
                      ...
                      <input  type="hidden"  name="id_igreja" id="id_igreja" value="<?php echo $id_igreja; ?>"> </input>
...
function editar(id,nome,email,telefone,endereco,produto,igreja){
    ...
    $.ajax({
            ...
            success: function(menssagem){
                ...
                if(menssagem.trim() == "Salvo com Sucesso"){
                      $('#btn-fechar').click()
                      window.location ='index.php?pag=fornecedores'
...
function InfoDados(nome,email,telefone,endereco,igreja,produto){
